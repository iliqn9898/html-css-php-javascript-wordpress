...
//промяна на елемент в масива като достъпим индекса му
<?php

 $users = ["Gosho", "Pesho", "Koko", "Iliyan", "Mariyan", "Fifi"];

 $users[1]= "Pesho_e_gey";
 ?>
 - по този начин елемента с индекс 1, ще бъде презаписан в масива с новото си име.
...
// Сумиране на първия и последния елемент на масив
<?php

$users = [12,33,4,5,6,16];
    
  echo $users[0]+$users[count($users)-1];
?>
